...
class GridMap:
    ...
    def add_ray(self, ray_init_position, ray_angle, ray_range, p_occ, mark_occupied=True):
        ...
        for pt in points[:-1]:
            ...
            self.update_cell(pt, 1 - p_occ) # Alternative: use 1-p_occ for free space
        ...
        if mark_occupied:
            ...
            self.update_cell(points[-1], 1 - p_occ) # Alternative: use 1-p_occ for free space
...
class OccupancyGridNode(Node):
    def __init__(self):
        ...
        self.declare_parameter('laser_frame', 'camera_link') #<--- For rosbag file
        ...
        self.scan_sub = self.create_subscription(
            LaserScan, '/turtlebot/fake_scan', self.scan_callback, 10
        )
